...
SECRET_KEY = 'vz-&amp;i-azx3=20@7j+2(ywon8v!8a%fwb1@sxtq!kx#%o$qr8)t'
...
if ENV == 'production':
    ...
    AWS_SECRET_ACCESS_KEY = os.environ('AWS_SECRET_ACCESS_KEY', None)
    AWS_STORAGE_BUCKET_NAME = os.environ('AWS_STORAGE_BUCKET_NAME', None)
